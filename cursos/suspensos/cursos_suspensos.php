  ...
  <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cursos</a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="../consulta.php">Ativos</a>
        </div>
      </li>
...
<form>
    <h5 class="card-title">Cursos suspensos:<button type="submit" name="submit" value="submit" class="btn btn-sm btn-ghost-danger" title="Excluir">
